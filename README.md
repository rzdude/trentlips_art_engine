...
# REPO IS SEVERELY OUTDATED AND RIFE WITH BUGS. USE AT YOUR OWN RISK. I AM UNABLE TO UPDATE IT AT THIS TIME DUE TO MY STUDIES.
...
If `noMeta` is true, the layer is automatically excluded from the uniqueness check, as if `bypassDNA` was also true.
